...
def pair_elements(lst): 
    """Helper function for converting 2 qubit gates from QSample to STIM"""
    ...
    **Attributes:**
    ...
    def from_qasm_circuit(self, qasm_str):
        ...
        **Attributes:**
        ...
        qasm_str: str
            A string defining the circuit in QASM
        """
    ...
    def from_qiskit_circuit(self, qc):
        ...
        **Attributes:**
        ...
        qc: qiskit.QuantumCircuit()
            A quantum circuit built with qiskit
        """
        self._ticks = ["foo"]
...
def qs2stim(circuit):
    """
    Produces a string defining a STIM circuit from a qsample circuit

    **Attributes:**

    circuit : qsample.Circuit()
    """
    stim_circuit = ""
